...
# (outputs: APUSH_paddleocr.pdf, APUSH_hunyuan.pdf, APUSH_deepseek.pdf)
./run_all.sh
...
See [server/README.md](server/README.md) for setting up vLLM OCR servers on a GPU machine (tested on NVIDIA DGX Spark with 128GB unified memory).
